...
## Project Structure
    ...
    ├── brokenlove_apparel_44880  # Django project configurations
...
1. Clone this repo and `cd brokenlove_apparel_44880`
...
2. Clone this repo and `cd brokenlove_apparel_44880`
